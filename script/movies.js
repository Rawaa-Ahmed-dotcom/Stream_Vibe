export * as movies from "./movies.js";
...
const apisArray = [
    fetch("http://localhost:5500/geners"),
    fetch("http://localhost:5500/top"),
    fetch("http://localhost:5500/trending"),
    fetch("http://localhost:5500/releases"),
    fetch("http://localhost:5500/must_watch"),
    fetch("http://localhost:5500/landingImages")
];
